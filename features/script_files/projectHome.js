...
let showImgOnWebpage = (value) => {
    ...
    if (value === "Prioritize Insights ....") {
        ...
        two.innerText = "Toggle specific project modules on and off to selectively gain insights within the project."
        ...
        let two = document.createElement("p")
        two.innerText = "Each project member can arrange their project home screen to fit their role and needs in a project."
        ...
        let two = document.createElement("p")
        two.innerText = "Eliminate cross-module management by accessing all project related work directly from one place."
