...
let showImgOnWebpage = (value) => {
    ...
    if (value === "Facilitate Ideas ....") {
        ...
        two.innerText = "Discussions enable real-time collaboration amongst project members to share ideas, collect feedback, and take meaningful decisions."
        ...
        let two = document.createElement("p")
        two.innerText = "Turn project discussions into quick-actions by converting a message into a task, or by creating a doc and auto-inviting all project members."
        ...
        let two = document.createElement("p")
        two.innerText = "Direct messages enable teammates to communicate outside of projects to stay better connected with everyone and everything."
