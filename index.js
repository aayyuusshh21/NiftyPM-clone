...
let cross = document.getElementById("cross_arrow").addEventListener("click", () => {
    let value = document.getElementById("video_trailer")
    let videos = document.querySelector("iframe")
    videos.src = "none";
...
let showImgOnWebpage = (value) =>{
    ...
    if(value === "Roadmaps ...."){
        ...
        two.innerText = "Set a visual timeline for your big-picture goals and build team alignment by automating progress as tasks are completed."
        ...
        let two = document.createElement("p")
        two.innerText = "Flexibly organize, prioritize, and track daily work with a high level of detail using Kanban, List, Timeline, Calendar, and Swimlane views."
        ...
        let two = document.createElement("p")
        two.innerText = "Empower all members to share ideas, finalize specifications, & gather feedback in real-time with chat and one-click video calls."
        ...
        let two = document.createElement("p")
        two.innerText = "Create beautiful docs, notes, and wikis for your projects and share with anyone. Nifty even integrates natively with Google Docs."
        ...
        let two = document.createElement("p")
        two.innerText = "Access automated progress reporting across all your projects and team activities to ensure operational clarity. "
...
let Para_tag_calling_Part_2 = (values) =>{
    ...
    if(values === "Engineering ...."){
        ...
        first_two.innerText = "Let go of fragmented tools. Plan, track, and manage your workflows with award-winning ease — in one collaborative workspace.";
        ...
        first_five.innerText = "✅ Manage issues, bugs, and changes directly in one place";
        ...
        let first_two = document.createElement("p");
        first_two.innerText = "Empower your sales teams by adding flow to their work with real-time reporting and insights using automated workflows.";

        let first_three = document.createElement("p");
        first_three.innerText = "✅ Track lead status and values for pipeline visibility";

        let first_four = document.createElement("p");
        first_four.innerText = "✅ Create & store sales collateral for streamlined access";

        let first_five = document.createElement("p");
        first_five.innerText = "✅ Automate the creation of projects upon closing of leads";
        ...
        let first_two = document.createElement("p");
        first_two.innerText = "Deliver better results with fewer tools. Manage tasks, campaigns, and marketing content with real-time collaboration in one place.";

        let first_three = document.createElement("p");
        first_three.innerText = "✅ Expedite approval for creatives with Proofing";

        let first_four = document.createElement("p");
        first_four.innerText = "✅ Create & track marketing campaigns as Milestones";

        let first_five = document.createElement("p");
        first_five.innerText = "✅ Align content schedules using Calendar View for Tasks";
        ...
        let first_two = document.createElement("p");
        first_two.innerText = "Build better products with team alignment. Create clear product roadmaps and automate progress reporting as tasks are completed.";

        let first_three = document.createElement("p");
        first_three.innerText = "✅ Prioritize & track feature sprints as Milestones";

        let first_four = document.createElement("p");
        first_four.innerText = "✅ Build spec documents using Nifty or Google Docs";

        let first_five = document.createElement("p");
        first_five.innerText = "✅ Improve decision-making with custom Project Embeds";
        ...
        let first_two = document.createElement("p");
        first_two.innerText = "Never lose a client due to poor communication again. Real-time collaboration to shorten feedback cycles and automate progress reporting.";

        let first_three = document.createElement("p");
        first_three.innerText = "✅ Instant messaging & one-click video meetings";

        let first_four = document.createElement("p");
        first_four.innerText = "✅ Centralize files & expedite approvals with Proofing";

        let first_five = document.createElement("p");
        first_five.innerText = "✅ Sharable project boards for real-time progress reporting";
        ...
        let first_two = document.createElement("p");
        first_two.innerText = "Streamline, centralize, and modernize your workflows. One app to manage your processes without letting anything fall through the cracks again.";

        let first_three = document.createElement("p");
        first_three.innerText = "✅ Gather tickets using forms & prioritize resolutions";

        let first_four = document.createElement("p");
        first_four.innerText = "✅ Automate ticket assignments with status assignees";

        let first_five = document.createElement("p");
        first_five.innerText = "✅ Plan project timelines & deployments using Roadmaps";
