...
let showImgOnWebpage = (value) =>{
    ...
    if(value === "Strategize Product Decisions ."){
        ...
        two.innerText = "Discuss ideas, collect feedback, and collaborate amongst project stakeholders for meaningful decision making."
        ...
        let two = document.createElement("p")
        two.innerText = "Build a visual roadmap for your product by defining milestones and adding tasks for automated progress tracking."
        ...
        let two = document.createElement("p")
        two.innerText = "Prioritize features by creating custom story maps using Kanban, List, or Swimlane views to focus on work that matters."
